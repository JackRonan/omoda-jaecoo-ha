...
# -*- coding: utf-8 -*-
"""
commands.py — Catalogo + invio dei comandi auto Omoda / Jaecoo (tspconsole EU REST).
...
# Dati PER-ACCOUNT: nessun default — forniti via omoda_jaecoo.env (vedi omoda_jaecoo.env.example).
...
COMMANDS = [
    ...
    ("defrost_parabrezza", {"endpoint": "frontWindshieldControl",
                   ...
                   "name": "Windshield defrost", "icon": "mdi:car-defrost-front", "group": "Clima"}),
    ("defrost_parabrezza_off", {"endpoint": "frontWindshieldControl",
                   "body": {"frontWindshieldHeat": "0"},
                   "name": "Windshield defrost OFF", "icon": "mdi:car-defrost-front", "group": "Clima"}),
    ("defrost_lunotto", {"endpoint": "backDefrostingControl",
                   "body": {"backDefrosting": "1", "times": "15"},
                   "name": "Rear window defrost", "icon": "mdi:car-defrost-rear", "group": "Clima"}),
    ("defrost_lunotto_off", {"endpoint": "backDefrostingControl",
                   "body": {"backDefrosting": "0"},
                   "name": "Rear window defrost OFF", "icon": "mdi:car-defrost-rear", "group": "Clima"}),
    ("volante_caldo", {"endpoint": "steeringWheelControl",
                   "body": {"controlType": "1"},
                   "name": "Steering wheel heating", "icon": "mdi:steering", "group": "Clima"}),
    ("volante_caldo_off", {"endpoint": "steeringWheelControl",
                   "body": {"controlType": "0"},
                   "name": "Steering wheel heating OFF", "icon": "mdi:steering", "group": "Clima"}),
    ...
    # 30_capture/omoda_jaecoo_capture_20260620/command_envelopes.txt. NB: usano `duration` (NON
    ...
    ("clima_riscalda_off", {"endpoint": "heatingControl",
                   ...
                   "name": "Heat up all OFF", "icon": "mdi:heat-wave", "group": "Clima"}),
